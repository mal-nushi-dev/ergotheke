...
const photographyGearSubpages = [
  { name: 'Sony DSLR-A300', slug: 'sony_dslr_a300', description: 'An entry-level DSLR with live view and fast autofocus.' },
  { name: 'Minolta X-370', slug: 'minolta_x_370', description: 'A classic Japanese 35mm film SLR.' },
];
