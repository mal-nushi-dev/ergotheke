 ...
 */
export default function FlashingText({text, flashWord, className }: FlashingTextProps): React.JSX.Element {
    ...
    <p className={className}>
      ...
      <style jsx>{`
        ...
        @keyframes cameraFlash {
          0%, 100% { color: inherit; }
          5% { color: white; text-shadow: 0 0 8px white, 0 0 15px white; }
          10% { color: inherit; text-shadow: none; }
        }
      `}</style>
    </p>
  );
