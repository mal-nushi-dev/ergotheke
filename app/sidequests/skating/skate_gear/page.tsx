...
export default function GearPage(): React.JSX.Element {
  const pageTitle = "My Skating Gear";
  const pageDescription = "Details about my skateboard setup and accessories.";
    ...
    <section>
      ...
      <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mb-8">
        {GearSubpages.map((subpage) => {
          ...
          const href =
            external ||
            `/sidequests/skating/skate_gear/${encodeURIComponent(
              subpage.slug
            )}`;
